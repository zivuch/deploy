...
This guide will walk you through the process of deploying a NodeJS application with React application as one application deployment in the [cloud][cloud].
You will use [Render][render], a [Platform-as-a-Service][paas] cloud, to run your application;
...
Inside your server folder, create a client folder and add your React App into this folder.
For example:
...
Add this to your `server.js`, make sure to add it at the end of the code file, add this:
...
![Render: setup your application](./images/render-04-setup-2.png)
